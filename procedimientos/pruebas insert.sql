...
(1, 'Prestamistas', 1, '/admin/listado-prestamista'),
(2, 'Jefes', 1, '/admin/listado-jefe'),
(3, 'Cuentas bancarias', 1, '/admin/listar-cuenta'),
(4, 'Solicitud', 1, '/admin/solicitud'),
(5, 'Ver prestamos', 1, '/admin/ver-estado-prestamo'),
(6, 'Ver solicitudes', 1, '/admin/listar-solicitud'),
(7, 'Ver cuotas', 1, '/admin/listado-cuota'),
(8, 'Prestamos', 1, '/admin/ver-prestamos-por-prestamista'),
(9, 'Ver Finanzas', '1', '/admin/ver-finanzas');
...
-- INSERT DE BANCO
 ...
 -- insert into tb_banco (nombre,estado) values ("BBVA",1);

-- SELECT * FROM tb_ubigeo LIMIT 1833;


-- INSERT DE UBIGEO
insert into tb_ubigeo
...
INSERT INTO tb_persona (nombre, paterno, materno, celular, dni, id_ubigeo)
VALUES ('Admin', 'Admin', 'Admin', '999999999', '88888888', "150101");

INSERT INTO tb_usuario (username, password, image, correo, create_at, estado, id_rol, id_persona)
VALUES ('admin', '9f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08', '/img', 'admin@admin.com', '2023-10-05', 1, 1, 1);

INSERT INTO tb_tipo_cuenta 
VALUES (1,'Ahorros'),(2,'Simple'),(3,'A Plazo Fijo'),(4,'Nomina');
